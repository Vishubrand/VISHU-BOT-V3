...
module.exports.run = async function ({ api, event, args }) {
    ...
    if (userMessage.toLowerCase() === "on") {
        ...
        return api.sendMessage("मुझे राज ठाकुर ने चालू कर दिया है थैंक्यू ❤️", threadID, messageID);
    }
    ...
    if (userMessage.toLowerCase() === "off") {
        ...
        return api.sendMessage("Hmm! 😒 मुझे राज ठाकुर ने बंद कर दिया है 🫣🥺", threadID, messageID);
    }
